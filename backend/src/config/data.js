...
const materias = [
  ...
  { nombre: "Taller de Sistemas Operativos", esElectiva: false, idSemestre: 5 },
  ...
  { nombre: "Interacción Humano Computador", esElectiva: false, idSemestre: 7 },
  {
...
const grupos = [
  { nombre: "Grupo 1", docente: "Cespedes Guizada Maria Benita", idMateria: 1 },
  { nombre: "Grupo 2", docente: "Cespedes Guizada Maria Benita", idMateria: 1 },
  ...
  { nombre: "Grupo 5", docente: "Cespedes Guizada Maria Benita", idMateria: 1 },
  ...
  { nombre: "Grupo B5", docente: "Terrazas Vargas Juan Carlos", idMateria: 2 },
  { nombre: "Grupo B6", docente: "Terrazas Vargas Juan CArlos", idMateria: 2 },
  { nombre: "Grupo 10", docente: "Rogriquez Sejas Juan Antonio", idMateria: 3 },
  {
    nombre: "Grupo 15",
  ...
  { nombre: "Grupo 4", docente: "Villarroel Tapia Henry Frank", idMateria: 5 },
  ...
  { nombre: "Grupo 5A", docente: "Salinas Pericon Walter Oscar", idMateria: 7 },
  ...
  { nombre: "Grupo 12", docente: "Martinez Maida Amilcar Saul", idMateria: 8 },
  ...
  { nombre: "Grupo 1", docente: "Agreda Corrales Luis Roberto", idMateria: 14 },
  { nombre: "Grupo 1", docente: "Montoya Burgos Yony Richard", idMateria: 15 },
  { nombre: "Grupo 1", docente: "Camacho Del Castillo Indira", idMateria: 16 },
  { nombre: "Grupo 1", docente: "Flores Villarroel Corina", idMateria: 17 },
  { nombre: "Grupo 2", docente: "Manzur Soria Carlos B.", idMateria: 17 },
  { nombre: "Grupo 5", docente: "Montoya Burgos Yony Richard", idMateria: 17 },
  {
    nombre: "Grupo 3",
  ...
  { nombre: "Grupo 1", docente: "Orellana Araoz Jorge Walter", idMateria: 25 },
  { nombre: "Grupo 2", docente: "Orellana Araoz Jorge Walter", idMateria: 26 },
  ...
  { nombre: "Grupo 1", docente: "Montaño Quiroga Victor Hugo", idMateria: 27 },
  { nombre: "Grupo 1", docente: "Graficación por Computadora", idMateria: 28 },
  ...
  { nombre: "Grupo 1", docente: "Camacho del Castillo Indira", idMateria: 30 },
  { nombre: "Grupo 2", docente: "Torrico Bascope Rosemary", idMateria: 30 },
  { nombre: "Grupo 1", docente: "Orellana Araoz Jorge Walter", idMateria: 31 },
  { nombre: "Grupo 2", docente: "Orellana Araoz Jorge Walter", idMateria: 31 },
  {
    nombre: "Grupo 1",
  ...
  { nombre: "Grupo 2", docente: "Montaño Quiroga Victor Hugo", idMateria: 42 },
  ...
  { nombre: "Grupo 1", docente: "Montoya Burgos Yony Richard", idMateria: 43 },
  { nombre: "Grupo 1", docente: "Villaroel Tapia Henry Frank", idMateria: 44 },
  {
    nombre: "Grupo 1",
