          ...
          <FadeIn delay={500}>
            {usuario ? (
              <div className="flex flex-col items-center justify-between">
                <p className="text-white text-xl mt-10 font-semibold mb-2">
      ...
      <section className="w-full py-12 bg-gray-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 px-4">
          ...
          <Funcionalidad
            ...
            href={token == "" ? "/login" : "/horario"}
          />

          <button
            onClick={() => setProximamente(true)}
            className="group rounded-lg h-full bg-indigo-700 p-4 shadow-lg  hover:text-white flex flex-col items-center justify-center transition duration-300 transform  w-full"
          >
            <CheckCircleOutlineOutlined className="mb-2 text-4xl text-white group-hover:text-white transition duration-300" />
